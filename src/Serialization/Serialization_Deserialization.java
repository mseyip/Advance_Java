...
import java.io.*;
//ObjectOutputStream Java objelerini kodluyor ve karşılık gelen akışları(stream) oluşturur.
...
public class Serialization_Deserialization {
    ...
    public static void writeObjects(){
        ...
        try {
            ...
            //ObjectOutputStream'in objeleri akışa yazdırabilmesi için objeleri oluşturduğumuz Class Serializable interface'ini
